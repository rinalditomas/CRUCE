              ...
              {cadeterias.map((cadeteria)=>{
                ...
                <ListItem key={cadeteria.id}>
                  ...
                  <ListItemSecondaryAction>
                    {cadeteria.active?( <IconButton edge="end" aria-label="delete" onClick={()=>{handleActive(cadeteria.id)}}>
                      <BlockIcon />
                    </IconButton>) : (<IconButton edge="end" aria-label="delete" onClick={()=>{handleActive(cadeteria.id)}}>
                      <CheckIcon />
                    </IconButton>)}
                  </ListItemSecondaryAction>
                </ListItem>):(null))
